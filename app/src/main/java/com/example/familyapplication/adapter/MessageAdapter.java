...
import com.example.familyapplication.chat.ChatBigExpressionPresenter;
import com.example.familyapplication.chat.ChatFilePresenter;
import com.example.familyapplication.chat.ChatImagePresenter;
import com.example.familyapplication.chat.ChatRowPresenter;
import com.example.familyapplication.chat.ChatTextPresenter;
import com.example.familyapplication.chat.ChatVoicePresenter;
...
public class MessageAdapter extends BaseAdapter implements ListAdapter, SpinnerAdapter {

    private final static String TAG = "zjz message adapter";
    ...
    protected ChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        if(customRowProvider != null && customRowProvider.getCustomChatRow(message, position, this) != null){
            return customRowProvider.getCustomChatRow(message, position, this);
        }

        ChatRowPresenter presenter = null;

        switch (message.getType()) {
            case TXT:
                if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
                    presenter = new ChatBigExpressionPresenter();
                }else{
                    presenter = new ChatTextPresenter();
                }
                break;
            case LOCATION:
//                presenter = new EaseChatLocationPresenter();
                break;
            case FILE:
                presenter = new ChatFilePresenter();
                break;
            case IMAGE:
                presenter = new ChatImagePresenter();
                break;
            case VOICE:
                presenter = new ChatVoicePresenter();
                break;
            case VIDEO:
//                presenter = new ChatVideoPresenter();
                break;
            default:
                break;
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            presenter = (ChatRowPresenter) convertView.getTag();
        }
