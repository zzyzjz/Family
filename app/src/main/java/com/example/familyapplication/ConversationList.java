...
public class ConversationList extends ListView {
    private static final String TAG = "zjz ConversationList";
...
//    protected EaseConversationAdapter adapter;
    ...
    public ConversationList(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(List<EMConversation> conversationList, ConversationListHelper helper){
        conversations = conversationList;
        if(helper != null){
            this.conversationListHelper = helper;
        }
        Log.e(TAG, "---------68-----init: "+conversationList.size() );
//        adapter = new ConversationAdapter(context, 0, conversationList);
//        adapter = new ConversationAdapter(getContext(), 0, conversationList);
        adapter = new ConversationAdapter(context, 0, conversationList);
    ...
    private ConversationListHelper conversationListHelper;
    ...
    public void setConversationListHelper(ConversationListHelper helper){
